//SCRIPT FOR rapport POPUP CONTENT
  ...
  var jsonfile = '';
    ...
    function content(jsonfile) {
     ...
     document.querySelector('#hd_00').textContent = data.head_00;
    
     document.querySelector('#txt_00').textContent = data.text_00;
     ...
     document.querySelector('#hd_09').textContent = data.head_09;
   
     document.querySelector('#txt_09').textContent = data.text_09;


     document.querySelector('#hd_10').textContent = data.head_10;

     document.querySelector('#txt_10').textContent = data.text_10;


     document.querySelector('#hd_11').textContent = data.head_11;
   
     document.querySelector('#txt_11').textContent = data.text_11;
  ...
  function show_articles() {
    ...
    content('../dementia_t2_direct_learning/json/rapport.json');
