//SCRIPT FOR effective info POPUP CONTENT
  ...
  function show_article01() {
    ...
    content('../dementia_t2_direct_learning/json/effective_info.json');
  ...
  function show_article02() {
    ...
    content('../dementia_t2_direct_learning/json/question_tech.json');
